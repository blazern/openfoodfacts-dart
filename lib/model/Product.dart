...
class Product extends JsonObject {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    for (final String key in json.keys) {
      ...
      if (key.startsWith(ProductField.NAME_IN_LANGUAGES.key)) {
        OpenFoodFactsLanguage lang =
      ...
      // The OFF API also can give values in all available languages for some
      // of the fields. We store those values in same kinds of fields as
      // the product_name_[2 letter language code] values.
